...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.CustomComponent","com.vaadin.ui.Panel","com.vaadin.ui.TextArea","com.vaadin.ui.UI","com.vaadin.ui.Accordion","com.vaadin.ui.TwinColSelect","com.vaadin.ui.TextField","com.vaadin.ui.Table","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Tree","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.Image","com.vaadin.ui.Button","com.vaadin.ui.OptionGroup","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Video","com.vaadin.server.FileDownloader","com.vaadin.ui.Slider","com.vaadin.ui.InlineDateField","com.vaadin.ui.TreeTable","com.vaadin.ui.CustomLayout","com.vaadin.ui.ListSelect","com.vaadin.ui.Embedded","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.BrowserFrame","com.vaadin.ui.PasswordField","com.vaadin.ui.CustomField","com.vaadin.ui.MenuBar","com.vaadin.ui.FormLayout","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.TabSheet","com.vaadin.ui.NativeButton","com.vaadin.ui.PopupView","com.vaadin.ui.Label","com.vaadin.ui.Audio","com.vaadin.ui.GridLayout","com.vaadin.ui.Upload","com.vaadin.ui.Link","com.vaadin.ui.Window","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.DateField","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.CheckBox","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.ComboBox","com.vaadin.ui.JavaScript","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.NativeSelect","com.vaadin.ui.Form","com.vaadin.ui.Flash","com.vaadin.ui.CssLayout",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"hideErrors", "height", "tabIndex", "resources", "propertyReadOnly", "description", "caption", "required", "styles", "id", "enabled", "width", "errorMessage", "modified", "immediate", "registeredEventListeners", "primaryStyleName", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"styles", "description", "callbackNames", "enabled", "readOnly", "registeredEventListeners", "immediate", "height", "width", "rpcInterfaces", "id", "errorMessage", "resources", "primaryStyleName", "caption", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"registeredEventListeners", "codebase", "codetype", "archive", "immediate", "height", "caption", "resources", "errorMessage", "styles", "embedParams", "description", "classId", "primaryStyleName", "readOnly", "width", "id", "standby", "enabled", "alternateText", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"errorMessage", "propertyReadOnly", "primaryStyleName", "height", "textFieldEnabled", "styles", "tabIndex", "width", "registeredEventListeners", "modified", "resources", "required", "readOnly", "enabled", "id", "caption", "hideErrors", "immediate", "description", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"description", "readOnly", "styles", "id", "registeredEventListeners", "errorMessage", "immediate", "scrollLeft", "resources", "caption", "primaryStyleName", "height", "enabled", "scrollTop", "tabIndex", "width", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"immediate", "primaryStyleName", "templateName", "height", "templateContents", "width", "description", "enabled", "childLocations", "errorMessage", "readOnly", "caption", "resources", "styles", "registeredEventListeners", "id", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"columns", "marginsBitmask", "readOnly", "styles", "rows", "registeredEventListeners", "caption", "resources", "errorMessage", "id", "enabled", "spacing", "childData", "immediate", "primaryStyleName", "height", "width", "description", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"propertyReadOnly", "description", "primaryStyleName", "id", "immediate", "minValue", "readOnly", "modified", "resolution", "resources", "errorMessage", "value", "required", "styles", "registeredEventListeners", "enabled", "maxValue", "width", "height", "caption", "orientation", "hideErrors", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"primaryStyleName", "resources", "width", "registeredEventListeners", "immediate", "enabled", "errorMessage", "styles", "height", "caption", "id", "childCss", "description", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"enabled", "required", "primaryStyleName", "propertyReadOnly", "caption", "registeredEventListeners", "styles", "modified", "height", "tabIndex", "immediate", "description", "resources", "readOnly", "id", "hideErrors", "errorMessage", "width", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"registeredEventListeners", "enabled", "modified", "resources", "required", "immediate", "tabIndex", "width", "readOnly", "description", "height", "caption", "hideErrors", "errorMessage", "id", "propertyReadOnly", "styles", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"registeredEventListeners", "immediate", "primaryStyleName", "resources", "readOnly", "alternateText", "styles", "caption", "id", "errorMessage", "width", "enabled", "description", "height", });
            ...
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"alternateText", "description", "caption", "height", "id", "errorMessage", "resources", "readOnly", "width", "registeredEventListeners", "styles", "enabled", "immediate", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"enabled", "height", "id", "errorMessage", "registeredEventListeners", "readOnly", "contentMode", "caption", "styles", "text", "description", "resources", "immediate", "primaryStyleName", "width", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"enabled", "rpcInterfaces", "callbackNames", "registeredEventListeners", "resources", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"description", "sourceTypes", "errorMessage", "sources", "autoplay", "registeredEventListeners", "enabled", "altText", "muted", "readOnly", "styles", "immediate", "resources", "primaryStyleName", "id", "height", "width", "caption", "showControls", "htmlContentAllowed", });
            ...
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"hideErrors", "inputPrompt", "registeredEventListeners", "text", "immediate", "tabIndex", "required", "description", "resources", "primaryStyleName", "maxLength", "modified", "width", "propertyReadOnly", "styles", "errorMessage", "caption", "columns", "readOnly", "id", "enabled", "height", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"errorMessage", "width", "caption", "required", "tabIndex", "readOnly", "resources", "primaryStyleName", "propertyReadOnly", "immediate", "registeredEventListeners", "height", "enabled", "hideErrors", "modified", "styles", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"enabled", "styles", "readOnly", "modified", "width", "resources", "height", "id", "tabIndex", "description", "hideErrors", "errorMessage", "immediate", "registeredEventListeners", "propertyReadOnly", "primaryStyleName", "caption", "required", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"immediate", "resources", "readOnly", "primaryStyleName", "enabled", "caption", "id", "styles", "width", "description", "registeredEventListeners", "alternateText", "height", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"locked", "maxPosition", "minPositionUnit", "positionReversed", "position", "minPosition", "positionUnit", "maxPositionUnit", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"errorMessage", "caption", "styles", "immediate", "enabled", "height", "width", "primaryStyleName", "id", "registeredEventListeners", "description", "readOnly", "resources", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"width", "readOnly", "id", "primaryStyleName", "caption", "immediate", "enabled", "styles", "resources", "description", "registeredEventListeners", "height", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"width", "readOnly", "registeredEventListeners", "childData", "description", "errorMessage", "enabled", "styles", "spacing", "caption", "resources", "primaryStyleName", "id", "marginsBitmask", "height", "immediate", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"id", "errorMessage", "width", "readOnly", "registeredEventListeners", "enabled", "disableOnClick", "immediate", "height", "htmlContentAllowed", "resources", "clickShortcutKeyCode", "primaryStyleName", "tabIndex", "description", "styles", "caption", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"id", "muted", "autoplay", "description", "height", "sourceTypes", "htmlContentAllowed", "showControls", "immediate", "resources", "enabled", "caption", "registeredEventListeners", "primaryStyleName", "styles", "sources", "width", "altText", "errorMessage", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"primaryStyleName", "connectorToCssPosition", "width", "readOnly", "enabled", "styles", "caption", "resources", "immediate", "id", "registeredEventListeners", "height", "description", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"immediate", "resources", "id", "width", "description", "styles", "caption", "errorMessage", "enabled", "registeredEventListeners", "readOnly", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"primaryStyleName", "enabled", "id", "errorMessage", "immediate", "description", "splitterState", "secondChild", "height", "caption", "registeredEventListeners", "firstChild", "width", "readOnly", "resources", "styles", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"registeredEventListeners", "styles", "enabled", "width", "errorMessage", "caption", "id", "primaryStyleName", "resizeLazy", "draggable", "scrollTop", "scrollLeft", "resources", "modal", "centered", "height", "readOnly", "resizable", "description", "immediate", "positionX", "tabIndex", "positionY", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"column2", "row2", "column1", "alignment", "row1", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"wordwrap", "hideErrors", "errorMessage", "primaryStyleName", "maxLength", "columns", "height", "modified", "enabled", "inputPrompt", "text", "registeredEventListeners", "styles", "immediate", "width", "required", "description", "tabIndex", "resources", "id", "propertyReadOnly", "rows", "caption", "readOnly", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"id", "propertyReadOnly", "enabled", "modified", "resources", "styles", "readOnly", "required", "immediate", "caption", "height", "primaryStyleName", "description", "registeredEventListeners", "width", "tabIndex", "errorMessage", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"errorMessage", "height", "width", "description", "id", "caption", "uriFragment", "registeredEventListeners", "features", "parameters", "styles", "enabled", "target", "readOnly", "immediate", "primaryStyleName", "resources", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"caption", "description", "indeterminate", "readOnly", "modified", "state", "tabIndex", "required", "errorMessage", "registeredEventListeners", "enabled", "resources", "primaryStyleName", "styles", "hideErrors", "height", "immediate", "pollingInterval", "id", "width", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"checked", "caption", "styles", "id", "propertyReadOnly", "height", "hideErrors", "errorMessage", "registeredEventListeners", "description", "readOnly", "modified", "resources", "tabIndex", "width", "enabled", "required", "immediate", "primaryStyleName", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"resources", "spacing", "readOnly", "width", "immediate", "marginsBitmask", "childData", "primaryStyleName", "caption", "enabled", "styles", "description", "registeredEventListeners", "height", "id", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"resources", "height", "errorMessage", "width", "immediate", "marginsBitmask", "childData", "registeredEventListeners", "caption", "styles", "enabled", "spacing", "description", "primaryStyleName", "readOnly", "id", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"width", "errorMessage", "tabIndex", "description", "styles", "clickShortcutKeyCode", "registeredEventListeners", "disableOnClick", "height", "enabled", "primaryStyleName", "readOnly", "immediate", "resources", "id", "caption", "htmlContentAllowed", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"enabled", "styles", "description", "id", "caption", "width", "height", "immediate", "primaryStyleName", "registeredEventListeners", "resources", "errorMessage", "readOnly", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"enabled", "resources", "names", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"id", "resources", "enabled", "height", "errorMessage", "description", "styles", "width", "registeredEventListeners", "immediate", "primaryStyleName", "readOnly", "caption", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"description", "primaryStyleName", "registeredEventListeners", "readOnly", "errorMessage", "hideOnMouseOut", "caption", "html", "enabled", "resources", "immediate", "width", "id", "styles", "height", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"description", "styles", "registeredEventListeners", "primaryStyleName", "immediate", "required", "readOnly", "height", "propertyReadOnly", "errorMessage", "modified", "enabled", "hideErrors", "tabIndex", "resources", "width", "id", "caption", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"metaKey", "altKey", "clientY", "button", "relativeY", "shiftKey", "clientX", "relativeX", "type", "ctrlKey", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"height", "firstChild", "registeredEventListeners", "errorMessage", "resources", "width", "styles", "primaryStyleName", "secondChild", "caption", "immediate", "splitterState", "description", "readOnly", "enabled", "id", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"styles", "primaryStyleName", "modified", "description", "height", "id", "caption", "enabled", "errorMessage", "width", "tabIndex", "registeredEventListeners", "hideErrors", "immediate", "propertyReadOnly", "readOnly", "resources", "required", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"modified", "height", "caption", "errorMessage", "required", "primaryStyleName", "styles", "description", "readOnly", "propertyReadOnly", "hideErrors", "tabIndex", "resources", "width", "registeredEventListeners", "enabled", "layout", "immediate", "id", "footer", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"caption", "primaryStyleName", "cursorY", "cursorX", "registeredEventListeners", "enabled", "description", "resources", "readOnly", "bgColor", "id", "immediate", "height", "styles", "errorMessage", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"styles", "id", "resources", "immediate", "errorMessage", "enabled", "width", "showDefaultCaption", "readOnly", "color", "caption", "htmlContentAllowed", "popupVisible", "primaryStyleName", "registeredEventListeners", "height", "description", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"rowCount", "immediate", "caption", "errorMessage", "id", "width", "registeredEventListeners", "description", "height", "readOnly", "styles", "resources", "columnCount", "primaryStyleName", "changedColor", "enabled", "changedX", "changedY", });
